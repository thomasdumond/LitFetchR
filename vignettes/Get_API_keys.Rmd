...
If you want a higher request rate (about 10 requests/second instead of 3), you can optionally register a free NCBI API key from your NCBI account, under Account Settings &rarr; API Key Management. It remains entirely optional.
...
**Now that you got your API keys, you can continue to the next tutorial &rarr; [LitFetchR (Tutorial)](https://thomasdumond.github.io/LitFetchR/articles/LitFetchr.html)**
